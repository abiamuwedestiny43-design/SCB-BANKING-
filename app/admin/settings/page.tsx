                  ...
                  <div className="space-y-3 p-5 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm">
                    ...
                    <div className="flex flex-col gap-2">
                      <Button
                        ...
                        disabled={bulkBusy}
                        className="w-full bg-indigo-600 text-white font-black hover:bg-indigo-700 transition-all uppercase tracking-widest text-[9px] h-10 shadow-md"
                      >
                        Enable All
                      </Button>
                      <Button
            ...
            <div className="space-y-6">
              <div className="relative">
                <Input
                  ...
                  className="bg-slate-50 border-slate-200 rounded-xl h-12 text-slate-900 font-mono text-xs focus:border-indigo-500 transition-all placeholder:text-slate-400"
                />
                <Button
                  size="sm"
                  onClick={async () => {
                  ...
                  className="absolute right-1 top-1 h-10 px-4 rounded-lg bg-indigo-600 text-white font-black text-[10px] uppercase tracking-widest hover:bg-indigo-700 shadow-md"
                >
                  {singleBusy ? "..." : "FETCH"}
                </Button>
              </div>
              ...
              {foundUser && (
                <div className="p-5 rounded-2xl bg-indigo-50 border border-indigo-100 space-y-5 animate-in fade-in slide-in-from-top-4 duration-300 shadow-sm">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-white border border-indigo-100 flex items-center justify-center text-indigo-600 font-black text-xs uppercase shadow-sm">
                      {foundUser.name[0]}
                    </div>
                    <div>
