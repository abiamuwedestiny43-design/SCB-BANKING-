  ...
  return (
    <div className="bg-white text-black min-h-screen overflow-hidden font-sans">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-slate-50/50 rounded-full blur-[120px] animate-pulse"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-slate-50/30 rounded-full blur-[120px] animate-pulse delay-700"></div>
      </div>

      {/* Hero Section */}
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-100 text-black text-sm font-bold tracking-wider mb-8 animate-fade-in uppercase">
          ...
          <p className="text-sm md:text-lg text-black max-w-3xl mx-auto leading-relaxed mb-12 animate-slide-up font-bold uppercase tracking-widest opacity-60">
            For over five decades, SCB BANKING BANK has been more than just a financial institution — we have been a trusted partner in helping individuals, families, and businesses grow and secure their future.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 border-y border-slate-100">
            {[
              ...
              <div key={index} className="text-center group">
                <div className="text-3xl md:text-4xl font-black text-black group-hover:text-black transition-colors">
                  {stat.number}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative group">
              <div className="absolute -inset-4 bg-gradient-to-r from-black/10 to-black/10 rounded-[3rem] blur-2xl opacity-50 group-hover:opacity-100 transition duration-1000"></div>
            ...
            <div className="space-y-8">
              <h2 className="text-3xl md:text-6xl font-black tracking-tighter text-black uppercase italic">
                Our <span className="text-black">Origins</span>
              </h2>
              <div className="space-y-6 text-black leading-relaxed text-sm md:text-lg font-bold uppercase tracking-widest opacity-60">
                <p>
                  At SCB BANKING BANK, we believe that finance is not just about numbers — it's about people. That's why we focus on building genuine relationships with our customers, offering personalized solutions designed to meet their unique needs.
                </p>
                <p>
              ...
              <div className="pt-4">
                <Link href="/contact">
                  <button className="flex items-center gap-2 text-black font-black uppercase tracking-widest text-sm group">
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-100 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-black/5 rounded-full blur-[120px]"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="p-12 rounded-[3rem] bg-white border border-slate-200 shadow-xl hover:border-slate-200 transition-all duration-500">
              <div className="h-16 w-16 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center mb-8">
                <Target className="w-8 h-8 text-black" />
              </div>
              <h2 className="text-2xl md:text-3xl font-black text-black mb-6 uppercase italic">Our <span className="text-black">Mission</span></h2>
            ...
            <div className="p-12 rounded-[3rem] bg-white border border-slate-200 shadow-xl hover:border-blue-200 transition-all duration-500">
              ...
              <h2 className="text-3xl font-black text-black mb-6 uppercase">Our Vision</h2>
      ...
      <section className="py-32 relative bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 text-black">
            <p className="text-xs font-black tracking-[0.5em] uppercase text-black mb-4">Core Principles</p>
            <h2 className="text-3xl md:text-6xl font-black tracking-tighter uppercase text-black italic">SCB BANKING <span className="text-black">Standards</span></h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="group p-10 rounded-[2.5rem] bg-white border border-slate-200 hover:border-slate-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 text-center"
              >
                ...
                <p className="text-black text-sm leading-relaxed font-medium">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4">
          <div className="relative rounded-[3rem] bg-white p-12 md:p-20 text-center space-y-8 overflow-hidden border border-slate-200 shadow-2xl">
            ...
            <h2 className="text-3xl md:text-7xl font-black tracking-tighter leading-tight relative z-10 text-black uppercase italic">Start Your Legacy <br /> with <span className="text-black">SCB BANKING</span></h2>
            <p className="text-black max-w-xl mx-auto relative z-10 font-medium">
              Join thousands of customers who trust us for their financial future.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-6 relative z-10">
              <Link href="/register">
                <button className="w-full sm:w-auto bg-black text-white px-10 py-5 rounded-2xl text-lg font-black hover:bg-black transition-all hover:scale-105 shadow-xl shadow-black/20">
                  Start Now
                </button>
              </Link>
              <Link href="/contact">
                <button className="w-full sm:w-auto bg-white text-black border border-slate-200 px-10 py-5 rounded-2xl text-lg font-bold hover:bg-slate-50 transition-all shadow-sm">
                  Contact Us
                </button>
              </Link>
            </div>
