        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center space-y-8">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-xl md:text-2xl text-black font-medium leading-relaxed">
              Scale with confidence. SCB provides the liquidity, controls, and insights your venture demands.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-20 items-center">
            <motion.div {...fadeInUp} className="lg:col-span-12 text-center mb-20">
              <h2 className="text-5xl md:text-7xl font-black text-black tracking-tighter mb-8 lowercase">
            ...
            <motion.div {...fadeInUp} className="lg:col-span-5 relative">
              <div className="p-10 rounded-[3rem] bg-slate-50 border border-slate-200 backdrop-blur-md space-y-8 shadow-2xl">
                <div className="h-16 w-16 rounded-2xl bg-slate-50 flex items-center justify-center text-black border border-slate-100 shadow-sm">
                  <PieChart className="w-8 h-8" />
                </div>
                <h3 className="text-3xl font-black text-black tracking-tighter lowercase">Liquidity Management</h3>
                <p className="text-black font-medium leading-relaxed">Manage operating and reserve accounts with granular roles. Automate approvals and vendor payments, and get richer context for every transaction.</p>
                <div className="pt-6 border-t border-slate-200 grid grid-cols-2 gap-6">
                  <div>
                    <p className="text-2xl font-black text-black">256-bit</p>
                    <p className="text-[10px] font-black text-black uppercase tracking-widest">Encryption Standard</p>
                  </div>
                  <div>
                    <p className="text-2xl font-black text-black">99.9%</p>
                    <p className="text-[10px] font-black text-black uppercase tracking-widest">System Uptime</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeInUp} className="lg:col-span-7">
              <div className="relative aspect-video rounded-[3rem] overflow-hidden border border-slate-200 group shadow-3xl">
                ...
                <div className="absolute bottom-10 left-10">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black text-white text-[9px] font-black uppercase tracking-widest shadow-lg">Secure Platform</div>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-32 relative bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-16">
          <div className="space-y-4">
            <h2 className="text-4xl font-black text-black tracking-tighter lowercase">Platform <span className="text-black italic">Capabilities</span></h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {metrics.map((m, i) => (
              <motion.div
                ...
                className="p-10 rounded-[2.5rem] bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-2xl hover:border-slate-100 transition-all group text-left"
              >
      ...
      <section className="py-32 relative overflow-hidden bg-slate-50">
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center space-y-12">
          <motion.div {...fadeInUp} className="space-y-4">
            <h2 className="text-5xl md:text-7xl font-black text-black tracking-tighter uppercase relative z-10">
              Ready to <span className="text-black italic">Accelerate?</span>
            </h2>
            <p className="text-xl text-black font-medium max-w-2xl mx-auto relative z-10">
              Onboard your venture to the SCB ecosystem and experience the future of commercial banking.
            </p>
          </motion.div>
