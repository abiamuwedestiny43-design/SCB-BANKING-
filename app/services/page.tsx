    ...
    <div className="bg-white text-black min-h-screen overflow-hidden font-sans">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-100 text-black text-[10px] font-black tracking-[0.3em] uppercase mb-8">
          ...
          <p className="text-sm md:text-lg text-black max-w-3xl mx-auto leading-relaxed mb-12 font-bold uppercase tracking-widest opacity-60">
            SCB BANKING provides a suite of elite financial frameworks designed to empower your journey. From personal wealth to institutional leverage, we orchestrate success at every scale.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              <div
                key={index}
                className="group p-10 rounded-[3rem] bg-slate-50 border border-slate-200/60 hover:border-slate-200 hover:bg-white transition-all duration-500 hover:-translate-y-2 flex flex-col hover:shadow-2xl hover:shadow-black/5 shadow-sm"
              >
                ...
                <h3 className="text-2xl font-black text-black mb-4 italic tracking-tight uppercase tracking-tighter">
                  {service.title}
                </h3>
                <p className="text-sm md:text-base text-black mb-10 flex-grow leading-relaxed font-bold uppercase tracking-widest opacity-60">{service.description}</p>
                <ul className="space-y-4 mb-10">
                  {service.features.map((feature, idx) => (
                    <li key={idx} className="flex items-center gap-3 text-sm text-black font-medium">
                ...
                <Link href={service.href} className="block w-full">
                  <button className="w-full py-5 rounded-2xl bg-black text-white font-black hover:bg-black transition-all text-xs uppercase tracking-widest shadow-lg shadow-black/20">
                    Explore Solutions
                  </button>
                </Link>
              </div>
      ...
      <section className="py-24 bg-slate-50 relative border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <p className="text-[10px] font-black tracking-[0.5em] uppercase text-black mb-6">SCB Platform</p>
              <h2 className="text-3xl md:text-6xl font-black text-black mb-8 tracking-tighter leading-tight uppercase italic">Fortified <span className="text-black">Digital Architecture</span></h2>
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-2">
                  ...
                  <p className="text-[10px] font-black text-black uppercase tracking-widest">Encryption Standards</p>
                </div>
                <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-2">
                  <div className="flex items-center gap-2 text-black font-black uppercase text-sm">
                    <BarChart3 className="w-5 h-5 text-black" /> Real-Time
                  </div>
                  <p className="text-[10px] font-black text-black uppercase tracking-widest">Instant Auditing</p>
                </div>
              </div>
            </div>

            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-black/20 to-black/20 rounded-[3rem] blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
      ...
      <section className="py-32 relative bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="relative rounded-[4rem] bg-slate-50 p-12 md:p-24 text-center space-y-10 overflow-hidden border border-slate-200 shadow-2xl">
            <h2 className="text-4xl md:text-6xl font-black text-black tracking-tighter leading-tight relative z-10 uppercase italic">Elevate <br /> <span className="text-black not-italic uppercase">Your Potential Today.</span></h2>
            <p className="text-xl text-black max-w-2xl mx-auto relative z-10 font-medium">
              Join the institutional-grade banking revolution. It takes less than 3 minutes to start your legacy.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-6 relative z-10">
              <Link href="/register">
                <button className="w-full sm:w-auto bg-black hover:bg-black text-white px-12 py-6 rounded-2xl text-xl font-black transition-all hover:scale-105 shadow-xl shadow-black/20 uppercase tracking-tight">
                  Open Account
                </button>
              </Link>
              <Link href="/contact">
                <button className="w-full sm:w-auto bg-white hover:bg-slate-50 text-black px-12 py-6 rounded-2xl text-xl font-black border border-slate-200 transition-all shadow-sm uppercase tracking-tight">
