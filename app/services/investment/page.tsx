      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden pt-36 pb-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center space-y-8">
          <motion.div
            ...
            className="space-y-4"
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-slate-200 text-black text-[10px] font-black uppercase tracking-[0.3em] mb-4 shadow-sm">
          ...
          >
            ...
            <Button size="lg" variant="outline" className="border-slate-200 bg-white hover:bg-slate-50 text-black font-black px-10 h-16 rounded-2xl backdrop-blur-md text-lg uppercase tracking-tight shadow-sm" asChild>
          ...
          <div className="grid lg:grid-cols-12 gap-20 items-center">
            <motion.div {...fadeInUp} className="lg:col-span-6 space-y-10">
              <h2 className="text-4xl md:text-6xl font-black text-black tracking-tighter leading-tight uppercase relative z-10">
                Compounding <br /><span className="text-black italic">Human Capital</span>
              </h2>
              ...
              <div className="flex gap-10 pt-6 relative z-10">
                <div className="space-y-1 text-center">
                  ...
                  <p className="text-[9px] font-black text-black uppercase tracking-widest">Asset Classes</p>
                </div>
                <div className="space-y-1 text-center">
                  <p className="text-3xl font-black text-black tracking-tighter">24/7</p>
                  <p className="text-[9px] font-black text-black uppercase tracking-widest">Market Watch</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeInUp} className="lg:col-span-6 relative">
              ...
              <div className="relative p-8 rounded-[3rem] bg-white border border-slate-200 backdrop-blur-md space-y-8 shadow-2xl overflow-hidden group">
                <div className="flex items-center justify-between mb-8">
                  <div className="h-12 w-12 rounded-xl bg-white flex items-center justify-center text-black border border-slate-200 shadow-sm">
                ...
                <p className="text-sm text-black font-medium italic">"Algorithmically managed portfolios outperform emotional triggers in 94% of observed market cycles."</p>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {metrics.map((m, i) => (
              <motion.div
                ...
                className="p-10 rounded-[2.5rem] bg-white border border-slate-100 hover:border-slate-100 hover:shadow-2xl transition-all group"
              >
                <div className="h-12 w-12 rounded-xl bg-white flex items-center justify-center text-black mb-8 border border-slate-200 group-hover:scale-110 transition-transform shadow-sm">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center space-y-12">
          <motion.div {...fadeInUp} className="space-y-4">
            <h2 className="text-5xl md:text-7xl font-black text-black tracking-tighter uppercase italic relative z-10">
              Start Scaling your <span className="text-black not-italic uppercase">Net Worth</span>
            </h2>
            <p className="text-xl text-black font-medium relative z-10">
              Bergabunglah dengan kalangan atas investor yang memanfaatkan platform investasi SCB.
            </p>
          </motion.div>
