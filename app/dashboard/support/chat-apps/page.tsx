...
export default function ChatAppsPage() {
    return (
        <div className="p-4 md:p-10 space-y-8 min-h-screen bg-slate-50/50">
            {/* Hero Header */}
            <div className="relative overflow-hidden rounded-[3rem] bg-indigo-600 p-8 md:p-12 text-white shadow-2xl shadow-indigo-200">
                <div className="absolute top-[-20%] right-[-10%] w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="space-y-4">
                        <h1 className="text-3xl md:text-5xl font-black tracking-tighter italic uppercase">
                            Secure Bank <br />
                            <span className="not-italic text-indigo-100">Support Apps</span>
                        </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {chatApps.map((app, i) => (
                    <Card key={i} className="group border-slate-200 hover:border-indigo-300 shadow-sm hover:shadow-xl transition-all duration-500 rounded-[2.5rem] overflow-hidden bg-white">
                        <CardHeader className="pb-4">
                            <div className="flex justify-between items-start mb-4">
                                <div className={`p-4 rounded-2xl bg-slate-100 text-slate-900 group-hover:bg-indigo-600 group-hover:text-white transition-colors`}>
                            ...
                            <p className="text-[10px] font-black text-indigo-600 uppercase tracking-[0.2em]">{app.category}</p>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <Button className="w-full bg-slate-900 hover:bg-indigo-600 text-white rounded-xl py-6 font-black uppercase tracking-widest text-xs transition-all shadow-lg shadow-slate-200">
            ...
            <Card className="bg-slate-900 border-none rounded-[3rem] p-8 md:p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    <div className="lg:col-span-2 space-y-6">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/20 text-indigo-300 rounded-full text-[10px] font-black uppercase tracking-widest">
                        ...
                        <h2 className="text-2xl md:text-4xl font-black text-white italic uppercase tracking-tight">
                            ...
                            <span className="text-indigo-400 not-italic">Identity as Priority</span>
                        </h2>
            ...
            <div className="text-center py-10">
                <p className="text-slate-400 text-xs font-black uppercase tracking-[0.3em] flex items-center justify-center gap-2">
                    <HelpCircle className="w-4 h-4" /> Need Immediate Assistance? <Link href="/dashboard/support" className="text-indigo-600 hover:underline">Contact Internal Support</Link>
                </p>
            </div>
        </div>
    )
