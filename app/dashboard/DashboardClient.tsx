            ...
            <div className="max-w-6xl mx-auto space-y-10 relative z-10">
                ...
                <motion.div {...fadeInUp} className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <DropdownMenu onOpenChange={(open) => open && handleMarkAsRead()}>
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" size="icon" className="h-12 w-12 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 relative text-white transition-all">
                                    ...
                                    {unreadCount > 0 && (
                                        <span className="absolute top-3 right-3 h-2.5 w-2.5 bg-indigo-500 border-2 border-[#020617] rounded-full"></span>
                                    )}
                                </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent align="end" className="w-80 p-2 rounded-2xl shadow-2xl border border-white/10 bg-[#1e293b]/95 backdrop-blur-md text-white">
                                <DropdownMenuLabel className="flex items-center justify-between p-3 border-b border-white/5">
                                    ...
                                    {unreadCount > 0 && <span className="bg-indigo-500 text-[#020617] text-[10px] px-2 py-0.5 rounded-full font-bold">{unreadCount} New</span>}
                                </DropdownMenuLabel>
                                            ...
                                            <DropdownMenuItem key={n._id} asChild className="p-0 focus:bg-white/5">
                                                <Link href={n.redirect || "/dashboard/notifications"} className="p-3 flex items-start gap-3 rounded-xl transition-colors group">
                                                    <div className={cn(
                                                        ...
                                                        n.message.toLowerCase().includes("debited") ? "bg-red-500/10 text-red-400" : "bg-indigo-500/10 text-indigo-400"
                                                    )}>
                                ...
                                <DropdownMenuItem asChild className="focus:bg-transparent p-0">
                                    <Link
                                        ...
                                        className="w-full py-3 text-center text-xs font-black text-indigo-400 uppercase tracking-widest hover:bg-indigo-500/10 rounded-xl transition-colors"
                                    >
                                        View All Activity
                                    </Link>
                                </DropdownMenuItem>
                        ...
                        <Link href="/dashboard/settings" className="group">
                            <div className="h-14 w-14 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-500 text-xl font-bold shadow-lg shadow-indigo-500/20 group-hover:scale-105 transition-all overflow-hidden">
                                {user.profileImage ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <motion.div {...fadeInUp} className="lg:col-span-2">
                        <Card className="h-full border-white/10 shadow-3xl bg-gradient-to-br from-[#1e293b] via-[#1e293b] to-[#011a0f] text-white overflow-hidden relative group rounded-[2.5rem]">
                                ...
                                <div className="flex justify-between items-center mb-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-indigo-500 font-bold">Account Active</p>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="px-3 py-1.5 rounded-lg bg-indigo-500/10 border border-indigo-500/20 flex items-center gap-2">
                                            <span className="text-[10px] font-black text-indigo-500 uppercase tracking-widest">Status: Verified</span>
                                        </div>
                                    </div>
                                </div>
                            </CardHeader>
                            <CardContent className="px-8 pb-8 relative z-10">
                                <div className="flex flex-wrap gap-4 pt-6 border-t border-white/5">
                                    <Button asChild className="bg-indigo-500 hover:bg-indigo-400 text-[#020617] font-black px-8 h-14 rounded-2xl shadow-xl shadow-indigo-500/20 transition-all hover:scale-105 active:scale-95 text-base">
                    ...
                    <motion.div {...fadeInUp} transition={{ delay: 0.1 }} className="grid grid-cols-1 gap-4">
                        <Card className="border-white/5 bg-white/[0.03] hover:bg-white/[0.05] p-6 flex items-center justify-between group transition-all duration-500 rounded-[2rem]">
                            <div className="space-y-1">
                                ...
                                <h3 className="text-xl font-black text-white group-hover:text-indigo-400 transition-colors">{user.bankAccount?.verified ? "Verified" : "Pending"}</h3>
                            ...
                            <div className={cn(
                                ...
                                user.bankAccount?.verified ? "bg-indigo-500/10 text-indigo-500 group-hover:bg-indigo-500 group-hover:text-[#020617]" : "bg-yellow-500/10 text-yellow-500 group-hover:bg-yellow-500 group-hover:text-[#020617]"
                            )}>
                        ...
                        <Card className="border-white/5 bg-white/[0.03] hover:bg-white/[0.05] p-6 flex items-center justify-between group transition-all duration-500 rounded-[2rem]">
                            <div className="space-y-1">
                                ...
                                <h3 className="text-xl font-black text-white group-hover:text-indigo-400 transition-colors">{user.bankAccount?.canTransfer ? "Enabled" : "Restricted"}</h3>
                                <p className="text-[10px] text-slate-600 font-medium">Secure transfer gateway</p>
                            </div>
                            <div className={cn(
                                "h-12 w-12 rounded-xl flex items-center justify-center transition-all shadow-lg",
                                user.bankAccount?.canTransfer ? "bg-indigo-500/10 text-indigo-500 group-hover:bg-indigo-500 group-hover:text-[#020617]" : "bg-red-500/10 text-red-500 group-hover:bg-red-500 group-hover:text-[#020617]"
                            )}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <motion.div {...fadeInUp} transition={{ delay: 0.2 }} className="lg:col-span-8 space-y-8">
                        <div className="flex items-center justify-between">
                            ...
                            <Button variant="ghost" asChild className="text-indigo-500 font-black hover:bg-indigo-500/10 rounded-xl text-xs uppercase tracking-widest">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {activeCards.length > 0 ? (
                                ...
                                <Card className="md:col-span-2 border-2 border-dashed border-white/5 bg-white/[0.02] rounded-[3rem] p-12 flex flex-col items-center justify-center text-center space-y-6">
                                    <div className="h-20 w-20 bg-indigo-500/10 rounded-[2rem] flex items-center justify-center text-indigo-500">
                                    ...
                                    <Button asChild className="bg-white text-[#020617] font-black px-10 h-14 rounded-2xl shadow-xl transition-all hover:scale-105 active:scale-95">
                    ...
                    <motion.div {...fadeInUp} transition={{ delay: 0.3 }} className="lg:col-span-4 space-y-8">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {[
                                { href: "/dashboard/transfer", label: "Send Money", sub: "Global transfers", icon: ArrowUpRight, color: "text-indigo-400", bg: "bg-indigo-500/10" },
                                ...
                                <Link key={i} href={action.href} className="group">
                                    <Card className="bg-white/[0.03] border-white/5 hover:bg-white/[0.06] p-4 flex items-center gap-4 transition-all group-hover:-translate-y-1 rounded-2xl">
                                        ...
                                        <div>
                                            <p className="font-bold text-white group-hover:text-indigo-400 transition-colors uppercase tracking-tight text-xs">{action.label}</p>
                                            <p className="text-[9px] text-slate-500 font-black uppercase tracking-widest">{action.sub}</p>
                                        </div>
                                        <ArrowRight className="h-3 w-3 ml-auto text-slate-700 group-hover:text-indigo-500 group-hover:translate-x-1 transition-all" />
                                    </Card>
                                </Link>
                            ))}
                        </div>
                                        ...
                                        >
                                            <div className="flex items-center gap-5">
                                                <div className={cn(
                                                    ...
                                                    transfer.txType === "credit" ? "bg-indigo-500/10 text-indigo-500" : "bg-red-500/10 text-red-500"
                                                )}>
                                                    {transfer.txType === "credit" ? <ArrowDownLeft className="h-6 w-6" /> : <ArrowUpRight className="h-6 w-6" />}
                                                </div>
                                                <div>
                                                    <p className="text-lg font-black text-white group-hover:text-indigo-400 transition-colors">
                                            ...
                                            <div className="text-right">
                                                <p className={cn(
                                                    ...
                                                    transfer.txType === "credit" ? "text-indigo-400" : "text-white"
                                                )}>
                                                ...
                                                <div className="flex items-center justify-end gap-1.5 mt-0.5">
                                                    <div className={cn(
                                                        ...
                                                        transfer.status === "success" ? "bg-indigo-500" : "bg-yellow-500"
                                                    )}></div>
                                                    <span className={cn(
                                                        "text-[9px] font-black uppercase tracking-tighter",
                                                        transfer.status === "success" ? "text-indigo-500" : "text-yellow-500"
