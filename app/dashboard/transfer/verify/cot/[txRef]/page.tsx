            ...
            {[
              ...
              <div key={idx} className="flex flex-col items-center gap-3 group">
                <div className={cn(
                  ...
                  step.active ? "bg-indigo-500 border-indigo-500 text-[#020617] shadow-[0_0_15px_rgba(16,185,129,0.5)] scale-110" : "bg-black/40 border-white/10 text-slate-700"
                )}>
                  {step.percent}
                </div>
                <span className={cn(
                  "text-[8px] font-black uppercase tracking-widest transition-colors",
                  step.active ? "text-indigo-500" : "text-slate-800"
                )}>{step.label}</span>
              </div>
            ))}
          </div>
