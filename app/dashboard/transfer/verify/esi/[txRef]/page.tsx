    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 md:p-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl space-y-10 relative z-10">
        ...
        <motion.div {...fadeInUp} className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
          <Button variant="ghost" onClick={() => router.push(`/dashboard/transfer/verify/imf/${txRef}`)} className="h-14 w-14 rounded-2xl border border-slate-200 bg-white text-slate-600 hover:bg-white group px-0 shrink-0 shadow-sm">
          ...
          <div className="space-y-1">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase">
              Security <span className="text-slate-400 italic">Auth</span>
            </h1>
            <p className="text-slate-600 font-medium">Stage 03: Security Protocol Verification Code</p>
          </div>
        </motion.div>
            ...
            <CardHeader className="p-10 pb-6">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-2">
                  <CardTitle className="text-3xl font-black text-slate-900 uppercase tracking-tighter">Security <span className="text-slate-400 italic">Gate</span></CardTitle>
                  <CardDescription className="text-slate-500 font-medium max-w-sm mx-auto">
                    Enter your high-security protocol code to authenticate the fund transfer.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="p-10 pt-0">
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="space-y-4 text-center">
                  <Label htmlFor="esiCode" className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Protocol Sequence</Label>
                  <Input
                    id="esiCode"
                    type="text"
                    value={esiCode}
                  ...
                  <p className="text-[9px] text-slate-400 font-black uppercase tracking-widest">
                    Mandatory secure protocol confirmation.
                  </p>
                </div>
