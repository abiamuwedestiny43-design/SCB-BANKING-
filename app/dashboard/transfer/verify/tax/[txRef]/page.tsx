        ...
        <motion.div {...fadeInUp} className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
          ...
          <div className="space-y-1">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter lowercase">
              Tax <span className="text-slate-500 italic">Verification</span>
            </h1>
            <p className="text-slate-400 font-medium">Stage 05: Tax Compliance</p>
          </div>
        </motion.div>
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <CardDescription className="text-slate-500 font-medium max-w-sm mx-auto">
                    Enter your Tax Authorization Code (TAX) to comply with international tax regulations.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="p-10 pt-0">
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="space-y-4 text-center">
                  <Label htmlFor="taxCode" className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em]">Enter Tax Code</Label>
                  <Input
                    id="taxCode"
                    type="text"
                    value={taxCode}
