...
export default function TechnologyPage() {
    return (
        <div className="bg-white text-black min-h-screen">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-orange-50">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16 space-y-6">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-200 text-black text-xs font-black tracking-widest uppercase">
                            <Server className="w-3 h-3" /> Banking Infrastructure
                        </div>
                        <h1 className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tighter text-black">
                            Your Finances, <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-black via-black to-black">
                                Perfectly Protected
                            </span>
                        </h1>
                    ...
                    <div className="relative group max-w-5xl mx-auto">
                        <div className="absolute -inset-1 bg-gradient-to-tr from-black to-black rounded-[2.5rem] blur-2xl opacity-20 group-hover:opacity-40 transition duration-1000"></div>
                        <div className="relative rounded-[2rem] overflow-hidden border border-slate-200 shadow-2xl">
                            <Image
                                src="/business-banking-hero.jpg"
                                alt="SCB BANKING - Advanced Banking Infrastructure"
                                width={1200}
                                height={700}
            ...
            <section className="py-32 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-20 space-y-4">
                        <span className="text-black font-bold tracking-wider text-xs uppercase px-3 py-1 rounded-full bg-slate-100 border border-slate-200">Our Technology</span>
                        <h2 className="text-4xl md:text-5xl font-black tracking-tight text-black">Enterprise-Grade Infrastructure</h2>
                        <p className="text-black max-w-2xl mx-auto text-lg">Built with the most advanced technology to ensure security, speed, and reliability.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="group p-8 rounded-[2rem] bg-gradient-to-br from-white to-slate-50 border border-slate-200 hover:border-orange-300 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <p className="text-black leading-relaxed text-sm">{tech.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-8">
                            <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-tight text-black">
                                Scalable & <br />
                                <span className="text-black">Resilient Architecture</span>
                            </h2>
                            ...
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-3 text-black font-medium">
                                        <CheckCircle2 className="w-5 h-5 text-black flex-shrink-0" /> {item}
                                    </li>
                                ))}
                            </ul>
                            ...
                            <div className="pt-6">
                                <Link href="/about">
                                    <button className="bg-black text-white px-8 py-4 rounded-xl font-bold hover:bg-black transition-all flex items-center gap-2 shadow-lg">
                        ...
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-r from-black to-purple-600 rounded-[2.5rem] blur-xl opacity-20"></div>
                            <Image
                            ...
                            <div className="absolute -bottom-6 -left-6 p-6 rounded-2xl bg-white border border-slate-200 shadow-xl z-20">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-black to-emerald-600 flex items-center justify-center">
                                        <Cpu className="w-6 h-6 text-white" />
                                    </div>
                                    <div>
                                        <p className="text-xs text-black uppercase font-bold tracking-wider">Processing Power</p>
                                        <p className="text-2xl font-black text-black">10k TPS</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-32 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="rounded-[3rem] bg-gradient-to-b from-slate-50 to-white p-8 md:p-16 border border-slate-200 overflow-hidden relative">
                        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-slate-100/50 rounded-full blur-[100px] pointer-events-none"></div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                            <div className="relative h-[500px] w-full rounded-[2rem] overflow-hidden border border-slate-200 shadow-2xl">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md px-6 py-4 rounded-xl border border-slate-200 flex items-center gap-3">
                                    ...
                                    <div>
                                        <span className="text-xs font-bold text-black uppercase tracking-wider block">All Systems Operational</span>
                                        <span className="text-[10px] text-black font-medium">Last checked: Just now</span>
                                    </div>
                                </div>
                            </div>

                            <div className="space-y-8">
                                <div className="inline-block p-3 rounded-xl bg-slate-100 border border-slate-200">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
                                        <h4 className="text-black font-bold text-lg mb-1">Biometric Auth</h4>
                                        <p className="text-black text-sm">Face ID & Fingerprint</p>
                                    </div>
                                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
                                        <h4 className="text-black font-bold text-lg mb-1">Real-Time Alerts</h4>
                                        <p className="text-black text-sm">Instant notifications</p>
                                    </div>
                                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
                                        <h4 className="text-black font-bold text-lg mb-1">AI Monitoring</h4>
                                        <p className="text-black text-sm">Fraud detection</p>
                                    </div>
                                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
                                        <h4 className="text-black font-bold text-lg mb-1">Zero Trust</h4>
                                        <p className="text-black text-sm">Network security</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {/* CTA */}
            <section className="py-20 pb-32 bg-gradient-to-br from-black to-black">
                <div className="max-w-4xl mx-auto px-4 text-center space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link href="/register" className="w-full sm:w-auto">
                            <button className="w-full bg-white text-black px-12 py-5 rounded-2xl text-xl font-black hover:bg-slate-50 transition-all hover:scale-105 shadow-2xl">
                                Create Your Account
                            </button>
                        </Link>
