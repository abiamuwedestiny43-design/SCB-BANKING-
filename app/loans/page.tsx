...
const LoansPage: React.FC = () => {
  return (
    <div className="bg-[#020617] text-slate-100 min-h-screen overflow-hidden font-sans">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="relative group max-w-5xl mx-auto">
            <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-[2.5rem] blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
              ...
              <div className="absolute bottom-10 left-10 text-left">
                <div className="flex items-center gap-4 p-6 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 uppercase tracking-widest font-black text-indigo-400">Decision in under 24 hours</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <p className="text-xs font-black tracking-[0.5em] uppercase text-indigo-500 mb-4">Our Frameworks</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group p-10 rounded-[3rem] bg-white/[0.03] border border-white/5 hover:bg-white/[0.05] transition-all duration-500 hover:-translate-y-2 flex flex-col">
                ...
                <Link href="/register">
                  <button className="w-full py-4 rounded-2xl bg-white/5 border border-white/10 text-white font-black group-hover:bg-indigo-500 group-hover:text-[#020617] group-hover:border-indigo-500 transition-all">
                    Apply Now
                  </button>
                </Link>
              </div>
          ...
          <div className="p-12 rounded-[3.5rem] bg-white/[0.03] border border-white/10 backdrop-blur-md shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-6">
                <div>
                  <label className="block text-[10px] font-black uppercase tracking-widest text-indigo-500 mb-2">Loan Amount</label>
                  <input type="number" className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 text-white focus:outline-none focus:border-indigo-500 transition-colors" placeholder="$10,000" />
                </div>
                <div>
                  <label className="block text-[10px] font-black uppercase tracking-widest text-indigo-500 mb-2">Loan Term</label>
                  <select className="w-full bg-[#0f172a] border border-white/10 rounded-2xl p-4 text-white focus:outline-none focus:border-indigo-500 transition-colors appearance-none">
              ...
              <div className="space-y-6 text-center md:text-left flex flex-col justify-end">
                <div className="p-8 rounded-3xl bg-indigo-500/10 border border-indigo-500/20 mb-6">
                  <p className="text-[10px] font-black uppercase tracking-widest text-indigo-400 mb-2">ESTIMATED MONTHLY</p>
                  <p className="text-5xl font-black text-white">$247.50</p>
                </div>
                <button className="w-full bg-indigo-500 hover:bg-indigo-400 text-[#020617] py-5 rounded-2xl font-black transition-all hover:scale-[1.02] shadow-xl shadow-indigo-500/20">
                  Submit Proposal
                </button>
              </div>
            </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black text-center text-white mb-20 tracking-tighter italic decoration-indigo-500 underline underline-offset-8">The Execution Path</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={index} className="relative group p-10 rounded-[3rem] bg-white/[0.02] border border-white/5">
                <div className="absolute top-10 right-10 text-5xl font-black text-indigo-500/10 group-hover:text-indigo-500/20 transition-colors">
                  {item.step}
                </div>
