...
export default function ForgotPasswordPage() {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center bg-white p-6 overflow-hidden selection:bg-indigo-500/30">
            {/* Background Layer */}
            ...
            <div className="relative z-10 w-full max-w-lg">
                <div className="text-center mb-10 space-y-4">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-indigo-50 border border-indigo-100 shadow-sm mb-2 group">
                        <Mail className="w-10 h-10 text-indigo-600 group-hover:scale-110 transition-transform" />
                    </div>
                    <div className="space-y-1">
                        <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase italic">
                            RESET <span className="text-indigo-600 font-medium">ACCESS</span>
                        </h1>
                ...
                <Card className="bg-white/70 backdrop-blur-2xl border-slate-200 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] rounded-[2.5rem] overflow-hidden relative">
                    ...
                    <CardContent className="p-8 pt-6">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {message && (
                                <Alert className="bg-indigo-50 border-indigo-100 text-indigo-600 rounded-2xl py-3 border italic font-black text-xs uppercase">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <Input
                                        ...
                                        required
                                        disabled={isLoading}
                                        className="h-14 pl-12 bg-white border-slate-200 rounded-2xl text-slate-900 focus:border-indigo-500/50 focus:ring-indigo-500/20 transition-all font-medium placeholder:text-slate-300"
                            ...
                            <div className="text-center pt-2">
                                <Link href="/login" className="inline-flex items-center text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-indigo-600 transition-colors">
