  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-white pt-[180px] pb-20 px-4 overflow-hidden selection:bg-indigo-500/30">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Animated Glows */}
        <div className="absolute top-1/4 left-10 w-[600px] h-[600px] bg-indigo-500/5 rounded-full blur-[150px] animate-pulse" />
      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <div className="text-center mb-10 space-y-4">
          ...
          <div className="space-y-1">
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase italic">
              IDENTITY <span className="text-indigo-600">PROVISION</span>
            </h1>
            <p className="text-slate-500 font-medium text-sm max-w-md mx-auto italic leading-relaxed">
              Establishing new secure node within the <span className="text-indigo-600 font-bold">FIRST STATE</span> global asset perimeter.
            </p>
          </div>
        </div>
        ...
        <Card className="bg-white/70 backdrop-blur-2xl border-slate-200 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] rounded-[3rem] overflow-hidden relative">
          ...
          <CardHeader className="p-10 pb-0">
            <CardTitle className="text-2xl font-black text-slate-900 tracking-tight uppercase border-l-4 border-indigo-600 pl-6">Core Credentials</CardTitle>
          </CardHeader>
          ...
          <CardContent className="p-10 pt-8">
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="space-y-6">
                <p className="text-[10px] font-black text-indigo-600/50 uppercase tracking-[0.4em] mb-4 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      placeholder="JOHN"
                      className="h-12 bg-white border-slate-200 rounded-xl text-slate-900 focus:border-indigo-500/50 focus:ring-indigo-500/20 transition-all font-bold tracking-tight px-4"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-indigo-600" />
                      <Input
                        type="date"
                        ...
                        required
                        className="h-12 pl-12 bg-white border-slate-200 rounded-xl text-slate-900 focus:border-indigo-500/50 transition-all font-bold tracking-tight"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(value) => handleChange("gender", value)}>
                      <SelectTrigger className="h-12 bg-white border-slate-200 rounded-xl text-slate-900 focus:border-indigo-500/50 transition-all font-bold tracking-tight px-4 ring-0 focus:ring-0">
                        <SelectValue placeholder="GENDER_SELECTOR" />
                      </SelectTrigger>
                      <SelectContent className="bg-white border-slate-200 text-slate-900">
                        <SelectItem value="male" className="focus:bg-indigo-50 focus:text-white font-bold">MALE_PROTOCOL</SelectItem>
                        <SelectItem value="female" className="focus:bg-indigo-50 focus:text-white font-bold">FEMALE_PROTOCOL</SelectItem>
                        <SelectItem value="others" className="focus:bg-indigo-50 focus:text-white font-bold">DIVERSE_PROTOCOL</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className="h-12 pl-12 bg-white border-slate-200 rounded-xl text-slate-900 focus:border-indigo-500/50 transition-all font-bold tracking-tight placeholder:text-slate-300"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        placeholder="••••••••••••"
                        className="h-12 bg-white border-slate-200 rounded-xl text-slate-900 focus:border-indigo-500/50 transition-all font-bold tracking-tight placeholder:text-slate-300"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-indigo-600" />
                        <Input
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        placeholder="••••"
                        className="h-12 bg-white border-slate-200 rounded-xl text-slate-900 focus:border-indigo-500/50 transition-all font-black text-xl text-center tracking-[0.5em] placeholder:text-slate-300"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="pt-6 space-y-6">
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-16 bg-indigo-600 hover:bg-indigo-700 text-white font-black uppercase tracking-[0.3em] text-[11px] rounded-2xl shadow-xl shadow-indigo-600/20 relative group overflow-hidden"
                >
                ...
                <div className="text-center">
                  <p className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">
                    ...
                    <Link href="/login" className="text-indigo-600 hover:text-indigo-700 transition-colors border-b border-indigo-500/20 hover:border-indigo-700">
                      Initialize Login
                    </Link>
                  </p>
                </div>
