...
export default function PinVerification({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-[#020617] border-indigo-500/20 rounded-[3rem] p-0 max-w-md overflow-hidden shadow-3xl">
        {/* Aesthetic Header Decoration */}
        <div className="h-2 bg-gradient-to-r from-transparent via-indigo-500/50 to-transparent" />
        ...
        <div className="p-10 relative overflow-hidden">
          ...
          <DialogHeader className="text-center relative z-10 space-y-4">
            <div className="mx-auto w-16 h-16 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center mb-2 animate-pulse">
          ...
          <form onSubmit={handleSubmit} className="space-y-8 mt-10 relative z-10">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-center gap-2 mb-2">
                <div className="px-3 py-1 rounded-full bg-white/5 border border-white/10 flex items-center gap-2">
                  <Cpu className="w-3 h-3 text-indigo-500/50" />
              ...
              <div className="relative group">
                <Input
                  ...
                  placeholder="••••"
                  maxLength={4}
                  className="h-24 text-center text-4xl font-black tracking-[1em] bg-white/5 border-white/10 rounded-2xl text-white focus:border-indigo-500/50 focus:ring-indigo-500/20 transition-all placeholder:text-white/5"
                  disabled={isLoading || attempts >= 3}
                  autoFocus
                />
                <div className="absolute inset-x-4 bottom-0 h-px bg-gradient-to-r from-transparent via-indigo-500/20 to-transparent" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <Button
                type="submit"
                className="w-full h-16 bg-indigo-500 hover:bg-indigo-400 text-[#020617] font-black uppercase tracking-[0.3em] text-[11px] rounded-2xl shadow-xl shadow-indigo-500/20 group relative overflow-hidden"
