    ...
    <div className="animate-fade-in pt-32">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-black mb-16">Mortgage Options</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              ...
              <div key={index} className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in-up" style={{ animationDelay: `${index * 150}ms` }}>
                <h3 className="text-xl font-semibold text-black mb-4">{mortgage.title}</h3>
                <p className="text-black mb-6">{mortgage.description}</p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="text-3xl font-bold text-center text-black mb-8">Mortgage Calculator</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-black mb-2">Home Price</label>
                <input type="number" className="w-full p-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent" placeholder="$300,000" />
              </div>
              <div>
                <label className="block text-sm font-medium text-black mb-2">Down Payment</label>
                <input type="number" className="w-full p-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent" placeholder="$60,000" />
              </div>
              <div>
                <label className="block text-sm font-medium text-black mb-2">Interest Rate (%)</label>
                <input type="number" className="w-full p-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent" placeholder="3.125" step="0.001" />
              </div>
              <div>
                <label className="block text-sm font-medium text-black mb-2">Loan Term</label>
            ...
            <button className="w-full mt-6 bg-black text-white py-3 rounded-lg hover:bg-black transition-colors font-medium">
              Calculate Payment
            </button>
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-slate-50 rounded-lg">
                <div className="text-2xl font-bold text-black mb-2">$1,157</div>
                <div className="text-black text-sm">Principal & Interest</div>
              </div>
              <div className="text-center p-6 bg-blue-50 rounded-lg">
                <div className="text-2xl font-bold text-blue-600 mb-2">$250</div>
                <div className="text-black text-sm">Property Tax</div>
              </div>
              <div className="text-center p-6 bg-slate-50 rounded-lg">
                <div className="text-2xl font-bold text-black mb-2">$100</div>
                <div className="text-black text-sm">Insurance</div>
              </div>
            </div>
            <div className="mt-6 text-center p-6 bg-slate-100 rounded-lg">
              <div className="text-3xl font-bold text-black mb-2">$1,507</div>
              <div className="text-black">Total Monthly Payment</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-black mb-16">Your Path to Homeownership</h2>
