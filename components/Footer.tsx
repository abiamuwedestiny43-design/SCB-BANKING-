        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-6">
            <Link href="/" className="inline-block group transition-transform hover:scale-105">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-black text-slate-900 tracking-tighter uppercase italic">FIRST<span className="text-orange-600 font-medium">STATE</span></span>
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600 font-bold">
              ...
              <li><Link href="/services/mortgage" className="hover:text-orange-600 transition-colors">Mortgages</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600 font-bold">
              ...
              <li><Link href="/branches" className="hover:text-orange-600 transition-colors">Branch Locator</Link></li>
